class Statistics:
    ...
    # ============================================================
    BANDWIDTH_NETWORK = 100_000_000      # 1.00E+08 bytes/s
    BANDWIDTH_RAM = 25_000_000_000        # 2.5E+10 bytes/s
    NETWORK_PRICE = 1.10e-11             # €/B (euros per byte)
    CO2_NETWORK = 1.10e-11               # kgCO2eq per byte
    CO2_RAM = 2.80e-11                   # kgCO2eq per byte
    DEFAULT_INDEX_SIZE = 1_000_000       # ~1 MB secondary local index
    NB_SRV_WORKING_CONSTANT = 50         # Constant for nb_srv_working when S > 1
